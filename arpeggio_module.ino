    ...
    if (arpModule.arpState == arp_acti)
    {
        ...
        if (arp_cnt > arpModule.gate)
        {
            ...
            if (arpNote != 0xFF)
            {
                ...
                {
                    FmSynth_NoteOff(0, voice->activeNote);
                }
            }
#else
            if (arpNote != 0xFF)
            {
                FmSynth_NoteOff(arpModule.activeCh, arpModule.activeNote);
            }
#endif
        }
        ...
        if (arp_cnt > arpModule.tempo)
        {
            ...
            if (arpNote != 0xFF)
            {
                ...
                FmSynth_NoteOn(arpModule.activeCh, arpModule.activeNote, 1);
#if 0
                /*
                ...
                {
                    FmSynth_NoteOff(0, voice->oldNote);
                }
#endif
                arp_act = arp_pos;
                arp_pos ++;
...
void FmSynth_ArpActive(float value)
{
